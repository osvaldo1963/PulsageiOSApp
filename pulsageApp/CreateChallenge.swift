...
class CreateChallenge: UIViewController {
    ...
    private func addviews() {
        ...
        self.challengeTitle.topAnchor.constraint(equalTo: self.blackCover.topAnchor, constant: 50).isActive = true
        ...
        self.createChallengeBtn.topAnchor.constraint(equalTo: self.challengeTitle.bottomAnchor, constant: 20).isActive = true
