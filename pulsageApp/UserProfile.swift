...
extension UserProfile: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        view.addPictureBtn.addTarget(self, action: #selector(self.changePicture), for: .touchUpInside)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            ...
            challengepage.challengeid = indexData.objectId!
            challengepage.challengeTitle = title
