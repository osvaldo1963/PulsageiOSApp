...
class sectionFooter: UIView {
    ...
    private func subViews() {
        ...
        self.ChallengeText.frame = CGRect(x: frame.size.width / 4 * 3 + 10, y: 5, width: frame.size.width / 4 , height: 20)
        
        self.addSubview(self.ArrowBtn)
        self.ArrowBtn.frame = CGRect(x: frame.size.width / 4 * 3 , y: 25, width: frame.size.width / 4, height: 40)
